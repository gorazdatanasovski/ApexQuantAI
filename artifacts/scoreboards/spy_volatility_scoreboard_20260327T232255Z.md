...
- Created at: 2026-03-27T23:22:55+00:00
...
```json
{
  ...
  "native_score": 0.28300000000000003,
  "updated_at": "2026-03-27T23:02:01+00:00",
  "securities": [
    "SKEW Index"
  ],
...
```json
{
  ...
  "status": "unverified_hypothesis",
  "native_score": 0.28300000000000003,
  "updated_at": "2026-03-27T23:01:58+00:00",
  "securities": [
    "VVIX Index"
  ],
...
```json
{
  ...
  "status": "unverified_hypothesis",
  "native_score": 0.28300000000000003,
  "updated_at": "2026-03-27T23:01:54+00:00",
  "securities": [
    "VIX3M Index"
  ],
  "statement_head": "Conjecture: Assume the latent log-volatility process X admits a Volterra representation X_t = X_0 + \u222b_0^t K(t,s) dW_s with local kernel singularity K(t,s) ~ c (t-s)^{H-1/2} for H in (0,1/2). Then, as \u0394 \u2193 0, the increment variance satisfies E[(X_{t+\u0394}-X_t)^2] = C_X \u0394^{2H} + o(\u0394^{2H}), and any realized-variance proxy constructed from sufficiently fine observations for VIX3M Index inherits the same scaling exponent after lower-order noise correction: E[RV_\u0394] = a_0 + a_1 \u0394^{2H} + o(\u0394^{2H}).",
  "metadata": {
...
```json
{
  ...
  "status": "unverified_hypothesis",
  "native_score": 0.28300000000000003,
  "updated_at": "2026-03-27T23:01:48+00:00",
  "securities": [
    "VIX Index"
  ],
  "statement_head": "Conjecture: Assume the latent log-volatility process X admits a Volterra representation X_t = X_0 + \u222b_0^t K(t,s) dW_s with local kernel singularity K(t,s) ~ c (t-s)^{H-1/2} for H in (0,1/2). Then, as \u0394 \u2193 0, the increment variance satisfies E[(X_{t+\u0394}-X_t)^2] = C_X \u0394^{2H} + o(\u0394^{2H}), and any realized-variance proxy constructed from sufficiently fine observations for VIX Index inherits the same scaling exponent after lower-order noise correction: E[RV_\u0394] = a_0 + a_1 \u0394^{2H} + o(\u0394^{2H}).",
  "metadata": {
...
```json
{
  ...
  "core_query": "Propose a theorem linking rough-volatility roughness to realized variance scaling for VIX3M Index.",
  "summary": {
    "task_name": "spy_volatility_universe_vix3m_index_spy_roughness_scaling",
    "securities": [
      "VIX3M Index"
...
```json
{
  ...
  "core_query": "Propose a theorem linking rough-volatility roughness to realized variance scaling for VIX Index.",
  "summary": {
    "task_name": "spy_volatility_universe_vix_index_spy_roughness_scaling",
    "securities": [
      "VIX Index"
...
```json
{
  ...
  "core_query": "Propose a theorem linking rough-volatility roughness to realized variance scaling for VVIX Index.",
  "summary": {
    "task_name": "spy_volatility_universe_vvix_index_spy_roughness_scaling",
    "securities": [
      "VVIX Index"
